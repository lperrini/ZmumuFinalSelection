...
void Reweighting1D(){
    ...
    TFile *f1             = new TFile("reweighting.root","r");
    TH2F *hmm             = (TH2F*)f1->Get("rweight_2d_mm");
    TH2F *hmt             = (TH2F*)f1->Get("rweight_2d_mt");
    TH2F *hmm_data        = (TH2F*)f1->Get("rweight_2d_mm_data");
    TH2F *hmm_MC          = (TH2F*)f1->Get("rweight_2d_mm_MC");
    TH2F *hmt_data        = (TH2F*)f1->Get("rweight_2d_mt_data");
    TH2F *hmt_MC          = (TH2F*)f1->Get("rweight_2d_mt_MC");
